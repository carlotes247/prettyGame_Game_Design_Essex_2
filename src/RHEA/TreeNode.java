...
public class TreeNode {
    ...
    TreeNode(TreeNode parent, int length, double value, Random generator) {
        this.parent = parent;
        this.value = value;
        nVisits = 1;
        if(parent != null)
    ...
    private void addChild(int action, double value) {
        if (children[action] == null)
            children[action] = new TreeNode(this, children.length, value, gen);
        else {
    ...
    int getBestChild() {
        ...
        for (int i = 0; i < children.length; i++) {
            ...
            if (n != null) {
                ...
                childValue = Utils.noise(childValue, epsilon, gen.nextDouble());
